...
public class Skills extends GameObject{
	...
	public Skills(float x, float y, Handler handler,ObjectId id, int velX) {
		super(x, y, id);
		this.velX = velX;
	...
	public void render(Graphics g) {
			g.drawImage(tex.skills[0], (int)x, (int)y, 30, 30, null);
